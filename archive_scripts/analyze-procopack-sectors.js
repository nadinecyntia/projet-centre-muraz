...
function analyzeSectorsInProcopack() {
    console.log('🔍 Analyse des secteurs dans procopack.xlsx\n');
    
    try {
        const workbook = XLSX.readFile('uploads/procopack.xlsx');
        ...
        if (errors.length > 0) {
            ...
            rawData.forEach((row, index) => {
                ...
                if (errors.includes(sector) && errorExamples < 5) {
