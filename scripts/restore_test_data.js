    ...
    try {
        ...
        for (const secteur of secteurs) {
            for (const periode of mois) {
                ...
                // 1. Breeding sites (gîtes larvaires)
                ...
                // 3. Adult mosquitoes (moustiques adultes)
        ...
        console.log('📊 Données de test restaurées avec des valeurs réalistes');
